...
impl<M: GuestAddressSpace> Queue<M> {
    ...
    pub fn iter<'b>(&'b mut self) -> AvailIter<'b, M> {
...
pub(crate) mod tests {
    ...
    fn test_checked_new_descriptor_chain() {
...

        {
            ...
            let mut c = DescriptorChain::<&GuestMemoryMmap>::checked_new(m, vq.start(), 16, 0).unwrap();
